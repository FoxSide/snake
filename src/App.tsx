...
const App = () => {
  ...
  const appleEat = (newSnake: number[][]) => {
  ...
  return (
    <div onKeyDown={(e) => changeDirection(e)}>
      ...
      <div className="scoreBox"><h2>Score: {score}</h2></div>
      <div className="scoreBox"><h2>High Score: {localStorage.getItem('snakeScore')}</h2></div>
    </div>
  );
};
